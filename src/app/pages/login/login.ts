        ...
        <div class="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="p-8">
                ...
                <form class="space-y-6">
                    <div>
                        ...
                        <input type="text" [formField]="loginForm.username" placeholder="Enter your username" class="w-full px-4 py-3 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                    ...
                    <div class="mt-2">
                        ...
                        <input type="password" [formField]="loginForm.password" placeholder="••••••••" class="w-full px-4 py-3 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                        <app-form-errors [control]="loginForm.password()"></app-form-errors>
                    </div>

                    
                    <button (click)="login()" [disabled]="loginForm().invalid()" size="lg" appButton type="button" class="w-full">
                        Sign In
                    </button>
                </form>
            </div>
            ...
            <div class="bg-slate-50 border-t border-slate-200 p-6 text-center">
                <p class="text-sm text-slate-600">
                    ...
                    <a routerLink="/register" class="font-semibold text-blue-600 hover:text-blue-500 hover:underline transition-all">Register here</a>
                </p>
            </div>
        </div>
    `,
